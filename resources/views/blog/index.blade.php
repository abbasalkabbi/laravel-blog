...
<div class="container mx-auto py-10">
    ...
    class="rounded-lg   bg-green-700  text-2xl  text-gray-100 py-2 px-3  font-bold uppercase place-self-start hover:bg-gray-500"
    >
        Add New Post
    </a>
</div>
    ...
    @foreach ($posts as $post)
        ...
        <div class="post container  sm:grid  grid-cols-2 gap-16 mx-auto p-15 m-5 ">
            ...
            <div class="content-post flex flex-col items-left justify-center m-10 sm:m-0">
                ...
                <a class="title-post  text-gray-400 text-lg italic py-4 hover:text-gray-700 flex	"    href="{{route('profile.show',$post->user->id)}}">
                    <img src="avatars/{{$post->user->avatar}}"  alt="" class="rounded-full	mx-2" style="width: 25px">
                    By:{{$post->user->name}}
                </a>
